...
function vehiculePrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/workshop/vehicule/vehicule_schedul_maintenance.php", 1).'?id='.$object->id;
	$head[$h][1] = $langs->trans("SchedulMaintenance");
	$head[$h][2] = 'schedul_maintenance';
	$h++;
