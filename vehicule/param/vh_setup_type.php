...
// Print form confirm
print $formconfirm;
$actionpathnew = dol_buildpath('/dolifleet/param/vh_setup_type.php', 2). '?action=new';
...
foreach ($typearray as $key=>$data) {
	...
	$actionpath = dol_buildpath('/dolifleet/param/vh_setup_type.php', 2) . '?rowid=' . $data->id . '&action=';
