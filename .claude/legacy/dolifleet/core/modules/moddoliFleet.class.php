...
/**
 *  Description and activation class for module doliFleet
 */
class moddoliFleet extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "ModDoliFleetDescription";
		...
		// for specific path of parts (eg: /dolifleet/core/modules/barcode)
		// for specific css file (eg: /dolifleet/css/dolifleet.css.php)
		...
		// Example: this->dirs = array("/dolifleet/temp");
		$this->dirs = array();
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=dolifleet',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'doliFleet top menu',
		//							'mainmenu'=>'dolifleet',
		//							'leftmenu'=>'dolifleet_left',			// This is the name of left menu for the next entries
		//							'url'=>'/dolifleet/pagetop.php',
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=dolifleet,fk_leftmenu=dolifleet_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'doliFleet left menu',
		//							'mainmenu'=>'dolifleet',
		//							'leftmenu'=>'dolifleet_left',			// Goes into left menu previously created by the mainmenu
		//							'url'=>'/dolifleet/pagelevel2.php',
		//							'langs'=>'dolifleet@dolifleet',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		...
		$this->menu[$r] = array(
			'fk_menu' => 'fk_mainmenu=dolifleet',                            // Put 0 if this is a top menu
			'type' => 'left',                            // This is a Top menu entry
			'titre' => $langs->trans('doliFleetVehiculeOperationList'),
			'mainmenu' => 'dolifleet',
			'leftmenu' => 'dolifleet_operationlist_left',
