...
$langs->loadLangs(array("dolifleet@dolifleet", "companies", "other", "mails"));
...
if ($id > 0 || !empty($ref)) $upload_dir = $conf->dolifleet->multidir_output[$object->entity ? $object->entity : $conf->entity]."/vehicule/".dol_sanitizeFileName($object->ref);
...
$permissiontoadd = $user->hasRight("dolifleet", "read"); // Used by the include of actions_addupdatedelete.inc.php
...
$title = $langs->trans("doliFleet").' - '.$langs->trans("Files");
$help_url = '';
