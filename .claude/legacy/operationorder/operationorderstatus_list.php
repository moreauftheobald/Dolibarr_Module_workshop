...
$newcardbutton = dolGetButtonTitle($langs->trans('NewStatus'), '', 'fa fa-plus-circle', dol_buildpath('operationorder/operationorderstatus_card.php?action=create&idmenu=540&mainmenu=operationorder', 1), '', $user->hasRight("operationorder", "status", "write"));
