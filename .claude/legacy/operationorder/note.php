...
$permissionnote = $user->hasRight("operationorder", "write"); // Used by the include of actions_setnotes.inc.php
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("OperationOrder"), -1, $object->picto);
