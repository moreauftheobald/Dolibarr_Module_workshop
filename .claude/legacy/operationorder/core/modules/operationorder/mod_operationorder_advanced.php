 ...
 */
class mod_operationorder_advanced extends ModeleNumRefOperationOrder
{
	/**
	...
	public function info()
	{
		...
		$tooltip.=$langs->trans("GenericMaskCodes4a", $langs->transnoentities("OperationOrder"), $langs->transnoentities("OperationOrder"));
	...
	public function getNextValue($object)
	{
		...
		if ($object->entity == 1) {
			// We get cursor rule
			$mask = getDolGlobalString("OPERATIONORDER_ADVANCED_MASK");
		} else {
			$sql = 'SELECT value
