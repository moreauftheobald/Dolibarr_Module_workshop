...
$langcode = (GETPOST('lang', 'aZ09', 1) ?GETPOST('lang', 'aZ09', 1) : (empty(getDolGlobalString("MAIN_LANG_DEFAULT")) ? 'auto' : getDolGlobalString("MAIN_LANG_DEFAULT") ));
...
if ((! empty($_POST['roworder'])) && (! empty($_POST['table_element_line']))
	...
	$row=new OperationOrder($db);
	$row->fetch($element_id);
