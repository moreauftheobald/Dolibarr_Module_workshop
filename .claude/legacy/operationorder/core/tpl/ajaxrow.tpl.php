...
$forcereloadpage = empty(getDolGlobalString("MAIN_FORCE_RELOAD_PAGE")) ? 0 : 1;
		...
		$(document).ready(function () {
			...
			$("#<?php echo $tagidfortablednd; ?>").tableDnD({
				onDrop: function (table, row) {
					...
					$.post("<?php echo dol_buildpath('operationorder/core/ajax/row.php', 1); ?>",
						{
							roworder: roworder,
