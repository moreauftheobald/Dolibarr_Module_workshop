...
elseif (is_file(__DIR__.'/../../../../main.inc.php'))$dir = __DIR__.'/../../../../';
else $dir = __DIR__.'/../../../';
...
.jq-schedule .sc_bar.improd {
	background-color: <?php print '#'.getDolGlobalString("OR_ACTIVITYPLANNING_IMPROD_COLOR"); ?>;
}

.jq-schedule .sc_bar.late {
	background-color: <?php print '#'.getDolGlobalString("OR_ACTIVITYPLANNING_LATE_COLOR"); ?>;
}

.jq-schedule .sc_bar.in-time {
	background-color: <?php print '#'.getDolGlobalString("OR_ACTIVITYPLANNING_INTIME_COLOR"); ?>;
}


.jq-schedule .sc_bar.inprogress {
	background-color: <?php print '#'.getDolGlobalString("OR_ACTIVITYPLANNING_INPROGRESS_COLOR"); ?>;
}
