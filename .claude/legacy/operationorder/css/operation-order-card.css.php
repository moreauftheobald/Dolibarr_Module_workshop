...
$colortextlink       = empty($user->conf->THEME_ELDY_ENABLE_PERSONALIZED) ? (empty(getDolGlobalString("THEME_ELDY_TEXTLINK")) ? $colortextlink : getDolGlobalString("THEME_ELDY_TEXTLINK") ) : (empty($user->conf->THEME_ELDY_TEXTLINK) ? $colortextlink : $user->conf->THEME_ELDY_TEXTLINK);
