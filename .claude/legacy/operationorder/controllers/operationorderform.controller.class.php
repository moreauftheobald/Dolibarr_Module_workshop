...
dol_include_once('/operationorder/class/html.operationorder_formcreatewebportal.class.php');

/**
 * Class for VehiculeListController
 */
class OperationOrderFormController extends Controller
{
	/**
	...
	public function action()
	{
		...
		$context->title = $langs->trans('OperationOrderFormTitle');
		$context->desc = '';
		$context->menu_active[] = 'operation_form';
		...
		$permissiondellink = 0;
		// set form list
		$formCardWebPortal = new OperationOrderFormCreateWebPortal($this->db);
		$formCardWebPortal->init('operationorder', null, $permissiontoread, $permissiontoadd, $permissiontodelete, $permissionnote, $permissiondellink);
