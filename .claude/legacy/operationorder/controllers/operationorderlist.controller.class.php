 ...
 */
class OperationOrderListController extends Controller
{
	/**
	 * @var OperationOrderFormListWebPortal Form for list
	 */
	protected $formList;
	...
	public function action()
	{
		...
		$context->title = $langs->trans('OperationOrderListTitle');
		$context->desc = '';
		$context->menu_active[] = 'operation_list';

		dol_include_once('/operationorder/class/html.operationorder_formlistwebportal.class.php');
		// set form list
		$formListWebPortal = new OperationOrderFormListWebPortal($this->db);
		$formListWebPortal->init('operationorder');
