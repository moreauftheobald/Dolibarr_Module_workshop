 ...
 */
class VSRListController extends Controller
{
	...
	public function action()
	{
		...
		$context->title = $langs->trans('VSRbyVehicule');
		$context->desc = "";
		$context->menu_active[] = 'vsr_list';

		dol_include_once('/operationorder/class/html.vsr_formlistwebportal.class.php');
		// set form list
		$formListWebPortal = new VSRFormListWebPortal($this->db);
