...
dol_include_once('/operationorder/class/html.driver_formcreatewebportal.class.php');
...
class DriverFormController extends Controller
{
	...
	public function action()
	{
		...
		$context->title = $langs->trans('DriverFormTitle');
		$context->desc = '';
		$context->menu_active[] = 'driver_list';
		...
		$permissiondellink = 0;
		// set form list
		$formCardWebPortal = new DriverFormCreateWebPortal($this->db);
		$formCardWebPortal->init('driver', null, $permissiontoread, $permissiontoadd, $permissiontodelete, $permissionnote, $permissiondellink);
