...
/**
 *       \file       htdocs/operationorder/ajax/productdefaultwarehouse.php
 *       \brief      File to return Ajax response on productdefaultwarehouse list request
 */
...
$object = new ProductDefaultWarehouse($db);

// Security check
if (!$user->hasRight('operationorder', 'productdefaultwarehouse', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax operationorder/ajax/productdefaultwarehouse.php");
