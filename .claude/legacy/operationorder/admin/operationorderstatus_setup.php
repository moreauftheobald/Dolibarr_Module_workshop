...
print dol_get_fiche_head($head, 'settingsStatus', $langs->trans("OperationOrderStatus"), -1, 'operationorder@operationorder');
...
$confkey = 'OPODER_STATUS_ON_CREATE';
$inputHtml = $form->selectarray('value'.$inputCount, $TstatusAvailable, getDolGlobalString($confkey), 0, 0, 0, '', 0, 0, 0, '', '', 1);
