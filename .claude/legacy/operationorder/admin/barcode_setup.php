...
if ($action == 'addbarcodeimp') {
	...
	$sql = "SELECT MAX(code) as code FROM ".$db->prefix()."operationorderbarcode";
	$resql = $db->query($sql);
...
$customInputHtml = $form->selectarray($confKey, $TAvailableBarCode, getDolGlobalString("OPERATION_ORDER_BARCODE_TYPE"), 1);
