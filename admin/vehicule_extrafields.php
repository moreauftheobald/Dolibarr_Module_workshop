 ...
 *		\ingroup    workshop
 *		\brief      Page to setup extra fields of vehicule
 */
...
$elementtype = 'workshop_vehicule'; //Must be the $table_element of the class that manage extrafield
...
$textobject = $langs->transnoentitiesnoconv("Vehicule");
...
print dol_get_fiche_head($head, 'vehicule_extrafields', $langs->trans($page_name), -1, 'workshop@workshop');
