...
/**
 *	\file       workshop/workshopindex.php
 *	\ingroup    workshop
 *	\brief      Home page of workshop top menu
 */
...
llxHeader("", $langs->trans("WorkshopArea"), '', '', 0, 0, '', '', '', 'mod-workshop page-index');
...
// Draft MyObject
if (isModEnabled('workshop') && $user->hasRight('workshop', 'read')) {
	$langs->load("orders");
...
if (isModEnabled('workshop') && $user->hasRight('workshop', 'read')) {
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."workshop_myobject as s";
