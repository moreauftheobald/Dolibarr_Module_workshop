...
class modWorkshop extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "ModuleWorkshopDesc";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "ModuleWorkshopDesc";

		// Author
		$this->editor_name = 'T-SERVICES';
		$this->editor_url = '';		// Must be an external online web site
		$this->editor_squarred_logo = '';					// Must be image filename into the module/img directory followed with @modulename. Example: 'myimage.png@workshop'
		...
		$this->module_parts = array(
			...
			'websitetemplates' => 0,
			'contactelement' => array('vehicule'=>img_picto('', 'fa-truck', 'class="pictofixedwidth"').$langs->trans('Vehicule')),
		);
		...
		$this->hidden = getDolGlobalInt('MODULE_WORKSHOP_DISABLED'); // A condition to disable module;
		...
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@workshop:$user->hasRight('workshop', 'read'):/workshop/mynewtab1.php?id=__ID__');
		// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@workshop:$user->hasRight('othermodule', 'read'):/workshop/mynewtab2.php?id=__ID__',
		...
		$this->menu[$r++]=array(
			...
			'type'=>'left',
			'titre'=>'Param_Workshop',
			'mainmenu'=>'workshop',
			'leftmenu'=>'workshop_param',
			'url'=>'/workshop/param/workshop_param_unified.php?context=atelier&tab=service_type',
			'langs'=>'workshop@workshop',
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("workshop") && getDolGlobalInt("WORKSHOP_USE_OR")',
		...
		$this->menu[$r++]=array(
			...
			'type'=>'left',
			'titre'=>'Param_Service_Type',
			'mainmenu'=>'workshop',
			'leftmenu'=>'workshop_param_service_type',
			'url'=>'/workshop/param/workshop_param_unified.php?context=atelier&tab=service_type',
			'langs'=>'workshop@workshop',
			'position'=>1000+$r,
			'enabled'=>'isModEnabled("workshop") && getDolGlobalInt("WORKSHOP_USE_OR")',
