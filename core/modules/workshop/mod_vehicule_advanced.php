...
/**
 * \file       htdocs/core/modules/workshop/mod_vehicule_advanced.php
 * \ingroup    workshop
 * \brief      File containing class for advanced numbering model of Vehicule
 */
...
/**
 *	Class to manage the Advanced numbering rule for Vehicule
 */
class mod_vehicule_advanced extends ModeleNumRefVehicule
{
	/**
	...
	public function info($langs)
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("Vehicule"), $langs->transnoentities("Vehicule"));
