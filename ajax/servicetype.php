...
/**
 *       \file       htdocs/workshop/ajax/servicetype.php
 *       \brief      File to return Ajax response on servicetype list request
 */
...
// Security check
if (!$user->hasRight('workshop', 'servicetype', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax workshop/ajax/servicetype.php");
