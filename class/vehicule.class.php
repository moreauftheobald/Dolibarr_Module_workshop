...
class Vehicule extends CommonObject
{
	 ...
	 */
	public $fields=array(
		"rowid" => array("type"=>"integer", "label"=>"TechnicalID", "picto"=>"fa-truck", "enabled"=>"1", 'position'=>10, 'notnull'=>1, "visible"=>"-1",),
		...
		"fk_vehicule_type" => array("type"=>"varchar(255)", "label"=>"Fkvehiculetype", "picto"=>"fa-truck", "enabled"=>"1", 'position'=>40, 'notnull'=>0, "visible"=>"-1", "css"=>"maxwidth500 widthcentpercentminusxx",),
		"fk_vehicule_mark" => array("type"=>"varchar(255)", "label"=>"Fkvehiculemark", "picto"=>"fa-truck", "enabled"=>"1", 'position'=>45, 'notnull'=>0, "visible"=>"-1", "css"=>"maxwidth500 widthcentpercentminusxx",),
		...
		"fk_contract_type" => array("type"=>"varchar(255)", "label"=>"Fkcontracttype", "picto"=>"company", "enabled"=>"1", 'position'=>80, 'notnull'=>0, "visible"=>"-1", "css"=>"maxwidth500 widthcentpercentminusxx",),
		...
		"dim_pneu" => array("type"=>"varchar(255)", "label"=>"Dimpneu", "picto"=>"company", "enabled"=>"1", 'position'=>95, 'notnull'=>0, "visible"=>"-1",),
