...
class Vehicule extends CommonObject
{
	...
	public $fields=array(
		...
		"fk_vehicule_type" => array("type"=>"integer:VehiculeType:workshop/class/vehiculetype.class.php", "label"=>"Fkvehiculetype", "picto"=>"", "enabled"=>"1", 'position'=>40, "visible"=>"1", "css"=>"maxwidth500 widthcentpercentminusxx","notnull"=>1),
		"fk_vehicule_mark" => array("type"=>"integer:VehiculeMark:workshop/class/vehiculemark.class.php", "label"=>"Fkvehiculemark", "picto"=>"", "enabled"=>"1", 'position'=>50, "visible"=>"1", "css"=>"maxwidth500 widthcentpercentminusxx","notnull"=>1),
...
//		}
	...
	public function validate($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_ACTIVATED, $notrigger, 'WORKSHOP_MYOBJECT_VALIDATE');
	}
