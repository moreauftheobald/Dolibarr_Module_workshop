...
/**
 * \file        class/vehiculeLink.class.php
 * \ingroup     workshop
 * \brief       CRUD class for VehiculeLink (vehicle-to-vehicle relationship)
 */

require_once DOL_DOCUMENT_ROOT.'/core/class/commonobject.class.php';

class WorkshopVehiculeLink extends CommonObject
{
	/** @var string $module Module name */
	public $module = 'workshop';

	/** @var string $table_element Table name in SQL */
	public $table_element = 'workshop_vehicule_link';

	/** @var string $element Name of the element */
	public $element = 'workshop_vehicule_link';
	...
	/**
	 * WorkshopVehiculeLink constructor.
